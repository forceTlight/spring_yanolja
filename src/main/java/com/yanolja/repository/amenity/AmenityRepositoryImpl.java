...
@Slf4j
@Repository
public class AmenityRepositoryImpl {
    private final NamedParameterJdbcTemplate namedParameterJdbcTemplate;

    public AmenityRepositoryImpl(NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
    ...
    public AmenityDTO findById(Integer id) {
        ...
        return namedParameterJdbcTemplate.queryForObject(AmenitySql.SELECT, parameterSource,
                new AmenityRepositoryImpl.amenityMapper());
    }
